...
public class RecursiveListTestDriver
{
   ...
   private static boolean test(@SuppressWarnings("rawtypes") RecursiveList list, int expectedDepth1, int expectedDepth2)
   {
      ...
      try
      {
         ...
         boolean pass = test((actualStackDepth == expectedDepth1
